...
BOOL	SetWBPresetDataCapability( LPRefObj pRefObj, NkMAIDWBPresetData* pWBPresetData, char* filename )
{
	BOOL	bRet;
	FILE	*stream;
	int		count = 0;
	...
	// Set preset data.
	bRet = Command_CapSet( pRefObj->pObject, kNkMAIDCapability_WBPresetData, kNkMAIDDataType_GenericPtr, (NKPARAM)pWBPresetData, NULL, NULL );
	if( bRet == false )
	{
...
//------------------------------------------------------------------------------------------------------------------------------------
BOOL	GetWBPresetDataCapability( LPRefObj pRefObj, NkMAIDWBPresetData* pWBPresetData )
{
	char buf[256];
	BOOL	bRet;
	...
	// Get preset data.
	bRet = Command_CapGet( pRefObj->pObject, kNkMAIDCapability_WBPresetData, kNkMAIDDataType_GenericPtr, (NKPARAM)pWBPresetData, NULL, NULL );
	if( bRet == false )
	{
...
BOOL SaveArrayCapability( LPRefObj pRefObj, ULONG ulCapID, char* filename )
{
	BOOL	bRet;
	NkMAIDArray	stArray;
	FILE *stream;
