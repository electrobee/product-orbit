...
protected:
	...
	EdsPropertyDesc _WhiteBalanceDesc;
	EdsPropertyDesc _evfAFModeDesc;

public:
	// Constructor
	CameraModel(EdsCameraRef camera):_camera(camera), _lockCount(0),
	_AEMode(0), _Av(0), _Tv(0), _Iso(0), _MeteringMode(0), _ExposureCompensation(0), _ImageQuality(0),
	_WhiteBalance(0), _AvailableShot(0), _evfMode(0), _evfOutputDevice(0), _evfDepthOfFieldPreview(0),
	_evfZoom(0), _evfAFMode(0)
...
public:
	...
	void setWhiteBalance( EdsUInt32 value)			{ _WhiteBalance = value; }
	...
	EdsUInt32 getWhiteBalance() const			{ return _WhiteBalance; }
	...
	EdsPropertyDesc getWhiteBalanceDesc()	const			{ return _WhiteBalanceDesc;}
	...
	void setWhiteBalanceDesc(const EdsPropertyDesc* desc)			{_WhiteBalanceDesc = *desc;}
...
public:
	...
	void setPropertyUInt32(EdsUInt32 propertyID, EdsUInt32 value)
	{
		switch(propertyID)
		{
			...
			case kEdsPropID_WhiteBalance:			setWhiteBalance(value);				break;
	...
	void setPropertyDesc(EdsUInt32 propertyID, const EdsPropertyDesc* desc)
	{
		switch(propertyID)
		{
			...
			case kEdsPropID_WhiteBalance:			setWhiteBalanceDesc(desc);			break;
	...
	EdsPropertyDesc getPropertyDesc(EdsUInt32 propertyID)
	{
		...
		switch(propertyID)
		{
			...
			case kEdsPropID_WhiteBalance:			desc = getWhiteBalanceDesc();			break;
