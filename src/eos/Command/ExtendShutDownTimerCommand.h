...
class ExtendShutDownTimerCommand : public Command
{
	
public:
	ExtendShutDownTimerCommand(CameraModel *model) : Command(model){}
	...
	virtual bool execute()
	{
		...
		//Taking a picture
		err = EdsSendCommand(_model->getCameraObject(), kEdsCameraCommand_ExtendShutDownTimer, 0);
