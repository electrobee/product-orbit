...
BOOLEAN __stdcall   HidD_GetInputReport(IN HANDLE device, OUT void *reportBuffer, IN ULONG bufferLen);
BOOLEAN __stdcall   HidD_SetOutputReport(IN HANDLE device, IN void *reportBuffer, IN ULONG bufferLen);
